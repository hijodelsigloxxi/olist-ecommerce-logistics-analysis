-- ============================================================
-- 05_delay_by_product_weight_volume.sql
-- Retrasos según peso y volumen del pedido
-- ============================================================
-- Objetivo:
-- Este script analiza si las características físicas del pedido
-- se relacionan con el rendimiento logístico.
--
...
-- - Se excluyen los registros con is_delayed IS NULL porque no pueden
...
-- - El volumen del producto se calcula como:
...
-- ============================================================
-- 1. Peso medio de pedidos retrasados y no retrasados
-- ============================================================
...
-- ============================================================
-- 2. Volumen medio de pedidos retrasados y no retrasados
-- ============================================================
...
-- ============================================================
-- 3. Coste medio de envío por rango de peso
-- ============================================================
...
GROUP BY weight_bucket, bucket_order
ORDER BY bucket_order;


-- ============================================================
-- 4. Tiempo medio de entrega por rango de peso
-- ============================================================
...
-- ============================================================
-- 5. Porcentaje de retraso por rango de peso
-- ============================================================
...
-- ============================================================
-- 6. Porcentaje de retraso por rango de volumen
-- ============================================================
